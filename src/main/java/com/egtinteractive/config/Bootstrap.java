...
public class Bootstrap {
	...
	final ProcessingRunner<ResponseData> processingRunner1 = new ProcessingRunnerImpl<>(parser, writer, recoveryManager, logger);
	...
	final ProcessingRunner<ResponseData> processingRunner2 = new ProcessingRunnerImpl<>(parserString, writerString, recoveryManager, logger);
